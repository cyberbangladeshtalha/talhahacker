...
logo = """
   Asif Javed
   ▄︻̷̿┻̿═━一
   THE ANONYMOUS TALHAHACKER TRICKER 
   THE LEGEND ℒℴνℯ
...
\033[1;91m======================================="""
print " \x1b[1;93m============================================================="
CorrectUsername = "talhahacker"
CorrectPassword = "talhahacker"
loop = 'true'
while (loop == 'true'):
    ...
    if (username == CorrectUsername):
        ...
        if (password == CorrectPassword):
            ...
            os.system('xdg-open 'https://www.facebook.com/profile.php?id=100071965235218)
    else:
